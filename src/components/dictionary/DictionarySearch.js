...
const DictionarySearch = () => {
  ...
  const handleAddToFlashcard = (definition, partOfSpeech = null) => {
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Tìm kiếm định nghĩa, phát âm, và ví dụ của từ tiếng Anh. Có thể bao
          gồm bản dịch tiếng Việt.
        </p>
      </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <p className="text-red-700">
              Sorry, we couldn't find "{searchTerm}". Please check the spelling
              and try again.
            </p>
          </div>
        </div>
      ...
      {showAddToFlashcard && (
        <AddToFlashcardModal
          ...
          onClose={() => setShowAddToFlashcard(false)}
          onSuccess={() => {
