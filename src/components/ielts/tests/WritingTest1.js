...
const WritingTest1 = ({ onComplete, onExit }) => {
  ...
  const generateChatGPTPrompt = () => {
    return `I need you to act as an expert IELTS Writing examiner. Please evaluate my IELTS Writing Task 1 essay and provide detailed feedback.
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">IELTS Writing Test 1</h2>
          <div
